  ...
  <div class="container">
    <form @submit="handleSubmit">
      ...
      <div class="flex flex-col gap-2">
        ...
        <input placeholder="placeholder" v-model="form.name" class="input" id="name" />
      </div>
      <div class="flex flex-col gap-2">
        <label for="name" class="text">Nome do preço</label>
        <input placeholder="placeholder" v-model="form.price" class="input" id="name" />
      </div>
      <div class="flex flex-col gap-2">
        <label for="name" class="text">Nome do descrição</label>
        <input placeholder="placeholder" v-model="form.description" class="input" id="name" />
      </div>
      <div class="flex flex-col gap-2">
        <label for="name" class="text">Nome do categoria</label>
        <input placeholder="placeholder" v-model="form.category" class="input" id="name" />
      </div>
